...
public class RouteDao extends BaseDao<Route> {
	...
	public int addRoute(Route route) throws SQLException {
		return save("INSERT INTO route(origin_id, destination_id) VALUES(?, ?)",
	...
	public Integer addRouteAndGetPrimaryKey(Route route) throws SQLException {
		return addAndGetGeneratedKey("INSERT INTO route(origin_id, destination_id) VALUES(?, ?)",
				new Object[] { route.getOriginId(), route.getDestinationId() });
	}
	...
	public int deleteRoute(Route route) throws SQLException {
		return delete("DELETE FROM route WHERE id = ?", new Object[] { route.getId() });
	}
	...
	@Override
	public Route getOneElement(ResultSet resultSet) throws SQLException {
		Route route = null;
		while (resultSet.next()) {
			route = new Route();
			route.setId(resultSet.getInt("id"));
			route.setOriginId(resultSet.getString("origin_id"));
			route.setDestinationId(resultSet.getString("destination_id"));
			return route;
		}
		return null;
	}
